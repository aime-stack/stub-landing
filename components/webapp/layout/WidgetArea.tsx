...
import { Search, TrendingUp, Users, ChevronRight, ArrowDownLeft, ArrowUpRight, Settings, Eye, EyeOff, RefreshCw, Newspaper } from 'lucide-react';
...
export function WidgetArea() {
  ...
  useEffect(() => {
    getTopNews().then(setNews).catch(console.error);
  }, []);
